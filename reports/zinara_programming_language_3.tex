...
\subsubsection{Operaciones sobre tipos definidos por el usuario}
Dado que los tipos definidos por el usuario son un alias, se operan
igual que el tipo al cual se le hace el alias.
