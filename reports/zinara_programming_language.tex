...
\begin{verbatim}
def <identificador>(<arg1> as <tipo1>, ..., <argN> as <tipoN>) return <<tipoR>>:
[codigo de la funcion]
end[def]
\end{verbatim}

Dónde \texttt{<tipoR>} es el tipo de retorno, y cada uno de los
argumentos \texttt{<argI>} tienen un tipo asignado \texttt{<tipoI>}.
...
secuencia de clases que establecen la representación sintáctica de
