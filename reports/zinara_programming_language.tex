...
*      &  Int  & Float & Char  & Bool  \\
	\hline \hline
Int    &   X   & Float & \emph{Error} & \emph{Error} \\
Float  & Float &   X   & \emph{Error} & \emph{Error} \\
Char   & \emph{Error} & \emph{Error} &   X   & \emph{Error} \\
Bool   & \emph{Error} & \emph{Error} & \emph{Error} &   X   \\
	\hline
\end{tabular}
\\
\begin{tabular}{|c||cccc|}
...
el cual todavia no se encuentra completamente implementado.\\
